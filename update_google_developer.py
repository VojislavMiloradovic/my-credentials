...
def main():
    ...
    # 1. Execute Loss Guard against stored baseline
    try:
    ...
    # 2. Sort combined entries reverse-chronologically
    combined_feed.sort(
    ...
    readme_lines.extend([
        ...
        "#### Latest Achievements",
        "",
        f"Showing latest 10 merged activities. View full data via [Platform Archive Index](./archives/{PLATFORM_PREFIX}-index.md) ([Raw Index]({index_raw})) or [Monolithic Complete File](./archives/{PLATFORM_PREFIX}-complete.md).",
        "",
