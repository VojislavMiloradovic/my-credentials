...
def main():
    ...
    readme_lines = [
        ...
        "",
        f"Showing latest 10 items. View the full dataset via [Platform Archive Index](./archives/{PLATFORM_PREFIX}-index.md) ([Raw Index]({index_raw})) or [Monolithic Complete File](./archives/{PLATFORM_PREFIX}-complete.md).",
        "",
