...
def main():
    ...
    for i, chunk_rows in enumerate(chunks, start=1):
        ...
        c_md = []
        c_md.append("---")
        c_md.append("archive_platform: AWS Skill Builder")
    ...
    idx_md = []
    idx_md.append("# AWS Skill Builder Archive Index\n")
    idx_md.append("This directory provides chunked, AI-readable historical records for AWS Skill Builder training activities.\n")
    ...
    md.append("**Public Profile:** [Verify AWS Profile](https://skillsprofile.skillbuilder.aws/user/vojislavmiloradovic)  \n")
