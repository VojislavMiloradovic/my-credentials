...
def main():
    ...
    for i, chunk_rows in enumerate(chunks, start=1):
        ...
        c_md = []
        c_md.append("---")
        c_md.append("archive_platform: Credly Verified Credentials")
    ...
    idx_md = []
    idx_md.append("# Credly Badges & Mapped Skills Index\n")
    idx_md.append("This directory provides chunked, AI-readable historical records for Credly badges and mapped skills.\n")
