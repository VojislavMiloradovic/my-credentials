...
""")
        ...
        archives_dir.mkdir()
        (archives_dir / "microsoft-learn-index.md").write_text(
            "Total Records Archived: 1000"
        )
        (archives_dir / "google-skills-index.md").write_text(
            "Total Records Archived: 2000"
        )

        with (
            patch("generate_llms_txt.README_PATH", str(readme)),
...
class TestLlmsTxtGeneration:
    ...
    def test_generate_llms_txt(self, temp_dir):
        ...
        with (
            ...
            patch(
                "generate_llms_txt.RAW_BASE_URL",
                "https://raw.githubusercontent.com/test/test/main/archives",
            ),
            patch(
                "generate_llms_txt.read_portfolio_counts",
                return_value={
                    "ms_learn_units": "100",
                    "ms_learn_xp": "1000",
                    "ms_learn_badges": "50",
                    "ms_learn_achievements": "200",
                    "gcp_badges": "300",
                    "aws_activities": "400",
                    "credly_credentials": "50",
                    "linkedin_certs": "60",
                    "gdev_badges": "70",
                    "gdev_activities": "80",
                },
            ...
            patch(
                "generate_llms_txt.calculate_domain_breakdown",
                return_value=(
                    {
...
class TestLlmsFullGeneration:
    ...
    def test_read_file_safe(self, temp_dir):
        ...
        missing_path = str(temp_dir / "missing.txt")
        expected = f"\n\n<!-- {missing_path} not found -->\n"
        assert read_file_safe(missing_path) == expected
    ...
    def test_generate_llms_full(self, temp_dir):
        ...
        with (
            patch("generate_llms_full.README_PATH", str(readme)),
