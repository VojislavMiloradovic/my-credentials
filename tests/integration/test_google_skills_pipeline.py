...
class TestGoogleSkillsFetch:
    ...
    @responses.activate
    def test_fetch_google_skills_json_api_success(self, temp_dir, sample_google_skills_json):
        responses.add(
            responses.GET,
    ...
    @responses.activate
    def test_fetch_google_skills_json_api_fallback_to_html(self, temp_dir, sample_google_skills_html):
    ...
    @responses.activate
    def test_fetch_google_skills_fallback_to_local_json(self, temp_dir, sample_google_skills_json):
        ...
        with patch("update_google_skills.VALIDATION_DIR", str(validation_dir)), \
...
class TestGoogleSkillsPipelineIntegration:
    ...
    def test_main_pipeline_success(self, temp_dir, sample_google_skills_json, mock_archiver, mock_loss_guard, mock_retired_rules):
        validation_dir = temp_dir / "for_validation"
        validation_dir.mkdir()
        local_json = validation_dir / "google_skills_badges.json"
        local_json.write_text(json.dumps(sample_google_skills_json))
        ...
        with patch("update_google_skills.VALIDATION_DIR", str(validation_dir)), \
             ...
             patch("update_google_skills.ARCHIVE_MONOLITH", str(archives_dir / "google-skills-complete.md")), \
    ...
    def test_main_pipeline_network_then_local(self, temp_dir, sample_google_skills_json, mock_archiver, mock_loss_guard, mock_retired_rules):
