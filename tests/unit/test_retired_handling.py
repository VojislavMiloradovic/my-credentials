...
class TestLoadRetiredRules:
    ...
    def test_load_retired_rules_no_file(self, temp_dir):
        ...
        with patch("update_aws_skills.RETIRED_URLS_FILE", str(temp_dir / "nonexistent.json")):
    ...
    def test_load_retired_rules_legacy_string_format(self, temp_dir):
        ...
        retired_file = temp_dir / "retired_urls.json"
        retired_file.write_text(json.dumps({"aws-skills": ["https://example.com/1", "https://example.com/2"]}))
...
class TestMarkRetired:
    ...
    def test_mark_retired_url_field_as_list(self):
        ...
        items = [
            ...
            {"id": "2", "title": "Badge 2", "url": "https://example.com/2", "learningPathUid": None},
        ]
...
class TestMarkRetiredCrossPlatform:
    ...
    def test_load_retired_rules_imports(self):
        ...
        for module_name in ["update_aws_skills", "update_google_skills", "update_credly_badges", "update_linkedin", "update_google_developer", "update_ms_learn"]:
