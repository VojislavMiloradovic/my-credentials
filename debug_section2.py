...
if idx >= 0:
    with open("section_output.txt", "wb") as out:
...
if idx2 >= 0:
    with open("section_output2.txt", "wb") as out:
        out.write(content[idx2 - 200 : idx2 + 200])
    print(f"total_certs at position {idx2}, written to file")
